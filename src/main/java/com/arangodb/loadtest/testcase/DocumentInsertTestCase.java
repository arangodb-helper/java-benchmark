 ...
 *
 */
public class DocumentInsertTestCase extends ArangoTestCase {
	...
	public DocumentInsertTestCase(final ArangoDB.Builder builder, final CliOptions options, final int num,
